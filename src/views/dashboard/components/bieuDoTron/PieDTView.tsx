...
import {pieStyles} from '../../styles/DashBoard.styles';
import {IDashboardState} from '../../redux';
import {MyIcon, MyText, MyView} from 'bases/components';

interface IPieDTViewProps extends IDashboardState {}
...
const mapStateToProps = (state: RootState) => {
  const {pieChart, isFirstLoading, isError, arrCurrentStorePieChartUnChecked} =
    state.DashboardReducer;

  return {pieChart, isFirstLoading, isError, arrCurrentStorePieChartUnChecked};
};
...
export default connect(mapStateToProps, null)(PieDTView);
