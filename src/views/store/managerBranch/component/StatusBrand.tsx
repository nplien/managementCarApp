...
import {BRAND_LIST} from 'configs/StatusConfig';
...
import {IManagerBranchState, setActive} from '../redux';

interface IProps extends Partial<IManagerBranchState> {
...
const mapStateToProps = (state: RootState) => {
  let {status} = state.ManagerBranchReducer;
  return {status};
};
