...
import {MyView, MyIcon, MyText, MyButton} from 'bases/components';
import {connect} from 'react-redux';
import {RootState} from 'views/app/redux/App.Reducer';
import {stackBarStyles} from '../../styles/BCBanHang.Styles';
...
interface IPropsBarComplex extends IBCBanHangState {}
  ...
  render() {
    ...
    return (
      <MyView style={stackBarStyles.container}>
        <MyButton
          transparent
          style={stackBarStyles.titleChart}
          onPress={() => {
            MyNavigator.navigate('DetailBCBanHang', {checkView: DETAIL_BCBH[0]});
          }}>
          <MyText style={stackBarStyles.myText}>Doanh thu</MyText>
...
const mapStateToProps = (state: RootState) => {
  const {arrCurrentStoreCotChongUnChecked, stackbarChart} = state.BCBanHangReducer;
