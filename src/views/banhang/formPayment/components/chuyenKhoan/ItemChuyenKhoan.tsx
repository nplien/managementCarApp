...
import ModalChuyenKhoan from './ModalChuyenKhoan';
...
class ItemChuyenKhoan extends PureComponent<IProps> {
...
export default connect(null, mapDispatchToProps)(ItemChuyenKhoan);
