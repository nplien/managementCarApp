...
import {IFilterCategoryState} from '../redux/FilterCategory.Type';
...
class TextSearch extends PureComponent<IProps> {
  ...
  render() {
    ...
    return (
      <MyView style={FilterCategoryStyle.viewTextSearch2}>
        <MyInput
          defaultValue={keyword}
          placeholder={'Tên hàng hóa/mã hàng hóa'}
          placeholderTextColor={COLOR.TEXT.SECONDARY}
          style={FilterCategoryStyle.textSearch2}
...
const mapStateToProps = (state: RootState) => {
  let {keyword} = state.FilterCategoryReducer;
  return {keyword};
};
