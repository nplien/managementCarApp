...
interface IProps extends IExportOrderState {
  setIsChuyenDiExport: typeof setIsChuyenDiExport;
  setIsNhapVeExport: typeof setIsNhapVeExport;
...
class ChiNhanh extends Component<IProps> {
  ...
  onChuyenDi = () => {
    this.props.setIsChuyenDiExport(!this.props.isChuyenDi);
  };

  onNhapVe = () => {
    this.props.setIsNhapVeExport(!this.props.isNhapVe);
  };
...
const mapStateToProps = (state: RootState) => {
  let {isChuyenDi, isNhapVe, arrStoreChuyenDi, arrStoreNhapVe} = state.ExportOrderReducer;
  return {isChuyenDi, isNhapVe, arrStoreChuyenDi, arrStoreNhapVe};
};
const mapDispatchToProps = (dispatch: any) => {
  return bindActionCreators(
    {setIsChuyenDiExport, setIsNhapVeExport, setStoreChuyenDiExport, setStoreNhapVeExport},
    dispatch
  );
};
